    ...
    <div className="min-h-screen bg-[#0A0A0F] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="w-10 h-10 rounded-xl bg-[#4A9FD9]/20 flex items-center justify-center">
            <TrendingUp className="w-5 h-5 text-[#4A9FD9]" />
          </div>
        ...
        <div className="bg-[#12121A] border border-[#2A2A35] rounded-2xl p-6">
          ...
          <p className="text-sm text-[#8888AA] mb-6">Melde dich an um fortzufahren</p>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-[#8888AA] mb-1.5">E-Mail</label>
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                className="w-full bg-[#0A0A0F] border border-[#2A2A35] rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-[#555566] focus:outline-none focus:border-[#4A9FD9]/50" placeholder="felix@content-leads.de" />
            </div>
            <div>
              <label className="block text-xs font-medium text-[#8888AA] mb-1.5">Passwort</label>
