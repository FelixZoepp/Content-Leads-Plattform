...
export function FeatureRow({icon,tone='success',checked=true,children,style}){
  const tile={success:{background:'var(--success-soft)',color:'var(--green-500)'},accent:{background:'var(--accent-soft)',color:'var(--gold-500)'},neutral:{background:'var(--gray-100)',color:'var(--text-secondary)'}}[tone];
